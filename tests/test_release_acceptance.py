...
EXPECTED_CHECK_IDS = {
    ...
    "north_star_packaged_acceptance",
...
def test_release_acceptance_harness_declares_artifact_and_e2e_contracts() -> None:
    ...
    for expected in (
        ...
        "gaming-room-desktop-work-area",
        "project-room-desktop-work-area",
        ...
        "local_learning_suggestions_review_drafts",
        "north-star-learning-enable",
        "north-star-journal-events",
        "north-star-suggestions-scan",
        "north-star-suggestion-drafts",
        "build_shortcut_draft",
        "build_draft_recipe",
        "creation_side_effects",
        "recipes_written_by_draft_probe",
        "north-star-learning-delete-data",
        "shortcut_component",
        "ritual_recipe",
        "Invoke-SuitePackQuarantineEvidence",
        "suite_pack_quarantine_no_auto_enable",
        "north-star-suite-import",
        "north-star-suite-list-imports",
        "auto_enable",
        "auto_run",
        "Set-NorthStarAggregateEvidence",
        "north_star_packaged_acceptance",
        "click_through_honest_unimplemented",

...
CANVAS_PACK_SCHEMA = "ritualist.canvas_pack.v1"
THEME_PACK_SCHEMA = "ritualist.theme_pack.v1"
CANVAS_PACK_EXTENSION = ".ritualistcanvas"
THEME_PACK_EXTENSION = ".ritualisttheme"
SUITE_PACK_EXTENSION = ".ritualistsuite"
...
class VisualPackError(RitualistError):
...
class ImportedVisualPackRecord:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "schema_version": "ritualist.visual_pack_import.v1",
...
def _load_theme(theme: str | Path) -> CanvasTheme:
    ...
    if str(theme).strip() in {"ritualist_default", "default"}:
        return CanvasTheme()

...
from setpiece import themes
from setpiece.errors import SetpieceError

from .models import CanvasDocument, CanvasThemeTokens

CANVAS_THEME_BRIDGE_SCHEMA_VERSION = "setpiece.canvas.theme_bridge.v1"
DEFAULT_CANVAS_THEME_IDS = {"", "default", "setpiece_default"}
...
def resolve_canvas_theme(
    ...
    *,
    ...
    if fail_on_invalid and not selection.valid:
        ...
        raise SetpieceError(f"canvas theme '{selection.theme_id}' is invalid: {details}")
    return selection

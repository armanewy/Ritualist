...
CANVAS_PERFORMANCE_SCHEMA_VERSION = "setpiece.canvas.performance.v1"
CANVAS_PERFORMANCE_DIAGNOSTICS_SCHEMA_VERSION = "setpiece.canvas.performance_diagnostics.v1"
...
def _profile_summary(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for row in rows:
        ...
        bucket["count"] += 1
    return {
        "schema_version": "setpiece.canvas.component_performance_profiles.v1",

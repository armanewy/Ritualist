...
CANVAS_SCHEMA_VERSION = "setpiece.canvas.v1"
LEGACY_CANVAS_SCHEMA_VERSION = "ritualist.canvas.v1"
SUPPORTED_CANVAS_SCHEMA_VERSIONS = frozenset(
    {CANVAS_SCHEMA_VERSION, LEGACY_CANVAS_SCHEMA_VERSION}
)
CANVAS_VALIDATION_SCHEMA_VERSION = "setpiece.canvas.validation.v1"
...
class CanvasThemeTokens(BaseModel):
    ...
    success_panel: str = "#12251f"
    warning_panel: str = "#252014"
    danger_panel: str = "#28151c"
    focus_panel: str = "#132235"
    border: str = "#203044"
...
class CanvasTheme(BaseModel):
    ...
    id: str = "setpiece_default"
    name: str = "Setpiece Default"
...
class CanvasDocument(BaseModel):
    ...
    def validate_schema(cls, value: str) -> str:
        if value not in SUPPORTED_CANVAS_SCHEMA_VERSIONS:

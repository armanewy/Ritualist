...
def _adapter_binding_for(action_name: str, family_name: str) -> PrimitiveAdapterBinding:
    ...
    if action_name.startswith("browser.") or family_name.startswith("browser."):
        return PrimitiveAdapterBinding("playwright", "managed_browser", "Setpiece Playwright adapter")
    ...
    return PrimitiveAdapterBinding("runtime", "built_in", "Setpiece runtime adapter")
...
def _read_only_primitive_specs() -> tuple[PrimitiveSpec, ...]:
    ...
    specs.extend(
        _read_only_specs(
            ...
            adapter=PrimitiveAdapterBinding("playwright", "managed_browser", "Setpiece browser read adapter"),
            parameters={
    ...
    specs.extend(
        _read_only_specs(
            ...
            adapter=PrimitiveAdapterBinding("diagnostics", "redacted_bundle", "Setpiece diagnostics artifact writer"),

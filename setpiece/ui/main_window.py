...
from setpiece.doctor import diagnose_recipe
...
from setpiece.paths import config_file, recipes_dir, runs_dir
from setpiece.recipe_loader import discover_recipes, load_recipe
from setpiece.recipe_step_builder import RecipeStepAppendController
from setpiece.run_logs import RunLogWriter, reconcile_running_runs
...
class MainWindow(QMainWindow):
    ...
    def show_diagnostics(self) -> None:
        try:
            ...
            QMessageBox.critical(self, "Setpiece Diagnostics", message)

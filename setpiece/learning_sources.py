...
_SOURCE_REGISTRY: dict[str, LearningSource] = {
    SETPIECE_JOURNAL_SOURCE_ID: LearningSource(
        id=SETPIECE_JOURNAL_SOURCE_ID,
        label="Setpiece journal",
        description="Local Setpiece run summaries and user-authored notes.",
    ),
    ...
    RECENT_ITEMS_SOURCE_ID: LearningSource(
        ...
        label="Recent items",
        description="Local recent Setpiece Rooms, shortcuts, and recipes.",
    ),
}

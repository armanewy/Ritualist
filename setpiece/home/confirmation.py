...
from setpiece.overlay import ConfirmationRequest, ScreenRect, format_confirmation_request
from setpiece.preferences import RememberedApprovalScope, can_remember_approval
    ...
    class QtHomeConfirmationPresenter:
        ...
        def _request_qt_confirmation(
            ...
            *,
            ...
            dialog = QDialog()
            self._dialog = dialog
            dialog.setWindowTitle("Setpiece Confirmation Required")
            ...
            dialog.setAccessibleName("Setpiece confirmation")
            ...
            if remember_scope_text:
                ...
                remember_scope.setObjectName("setpieceRememberScope")
            ...
            if remember_scope_text:
                ...
                remember.setObjectName("setpieceRememberButton")
...
def _show_win32_confirmation(request: ConfirmationRequest | str) -> bool:
    ...
    title = "Setpiece Confirmation Required"
...
def _show_win32_confirmation_async(
    ...
    *,
    ...
    Thread(target=decide, name="setpiece-win32-confirmation", daemon=True).start()

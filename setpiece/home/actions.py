...
from setpiece.home.models import HomeCardStatus, HomeLastRunStatus, HomeRuntimeEvent
from setpiece.learning_config import LocalLearningConfig


RecipeReference = str | Path
SETPIECE_JOURNAL_SOURCE_ID = "setpiece_journal"
        ...
        with self._lock:
            if self._owned_executor is None:
                self._owned_executor = ThreadPoolExecutor(
                    max_workers=1,
                    thread_name_prefix="setpiece-activity-journal",
                )
...
def create_activity_journal_hook(
    ...
    *,
    ...
    enabled = (
        config.is_source_enabled(SETPIECE_JOURNAL_SOURCE_ID)
...
class HomeActionService:
    ...
    def run_recipe(
        ...
        *,
        ...
        from setpiece.logging_setup import setup_logging
        from setpiece.overlay import NullOverlayController
        from setpiece.recipe_loader import load_recipe_reference
    ...
    def doctor_recipe(self, recipe_ref: RecipeReference) -> Any:
        ...
        from setpiece.recipe_loader import load_recipe_for_diagnostics
    ...
    def view_recipe(self, recipe_ref: RecipeReference) -> dict[str, Any]:
        from setpiece.recipe_transparency import view_recipe_payload
    ...
    def open_recipe_yaml(self, recipe_ref: RecipeReference) -> dict[str, Any]:
        from setpiece.recipe_transparency import open_yaml_payload
    ...
    def resolve_recipe_path(self, recipe_ref: RecipeReference) -> Path:
        ...
        from setpiece.recipe_loader import resolve_recipe_reference
    ...
    def resolve_runs_path(self) -> Path:
        ...
        from setpiece.paths import runs_dir
...
def _current_journal_source_enabled() -> bool:
    return _load_local_learning_config().is_source_enabled(SETPIECE_JOURNAL_SOURCE_ID)

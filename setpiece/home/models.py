...
from setpiece.config import DEFAULT_HOME_CATEGORIES
from setpiece.event_coalescing import EventCoalescer
...
class HomeRunHistoryCache:
    ...
    def refresh(self) -> None:
        from setpiece.run_logs import list_recent_runs, reconcile_running_runs, summarize_run_record
...
def _recipe_thumbnail_url(image_path: object, *, recipe_path: Path | None = None) -> str:
    ...
    if not raw:
        return ""
    from setpiece.home.assets import HomeThumbnailCache

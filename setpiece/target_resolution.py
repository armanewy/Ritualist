...
def default_target_providers() -> tuple[TargetDiscoveryProvider, ...]:
    from setpiece.integrations.battlenet_readiness import BattleNetReadinessProvider
...
def _recommended_next_action(
    ...
    *,
    ...
    if resolution.state is TargetState.INSTALL_MEDIA_PRESENT:
        return "Review detected install media manually; Setpiece will not install silently."

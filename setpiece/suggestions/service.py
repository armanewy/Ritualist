...
from setpiece.learning_service import learning_scan_payload
from setpiece.suggestions.miner import mine_suggestions
from setpiece.suggestions.models import Suggestion, SuggestionPrivacyLevel
from setpiece.suggestions.storage import SuggestionStore


SUGGESTIONS_SCAN_SCHEMA_VERSION = "setpiece.suggestions.scan.v1"
SUGGESTIONS_LIST_SCHEMA_VERSION = "setpiece.suggestions.list.v1"
SUGGESTIONS_SHOW_SCHEMA_VERSION = "setpiece.suggestions.show.v1"
SUGGESTIONS_DISMISS_SCHEMA_VERSION = "setpiece.suggestions.dismiss.v1"
SUGGESTIONS_DELETE_ALL_SCHEMA_VERSION = "setpiece.suggestions.delete_all.v1"


class SuggestionsServiceError(SetpieceError):

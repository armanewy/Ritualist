...
_ACTION_DESCRIPTIONS: dict[str, str] = {
    ...
    "browser.click_text": "Click visible text in the active Setpiece-managed browser page.",
    ...
    "browser.open": "Open a URL in a managed browser session with a Setpiece dedicated profile.",
    ...
    "browser.wait_text": "Wait until text is visible in the active Setpiece-managed browser page.",
    ...
    "target.inspect": "Inspect local target resolution and readiness without taking action.",
    "target.wait_state": "Wait until target resolution reaches an expected state or readiness state.",

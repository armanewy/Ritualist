---
name: setpiece-release-validation
description: Use for Setpiece release validation, packaged dogfood, release checklist updates, acceptance harness work, tag readiness, and v0.2/v0.3 release gates. Enforces Setpiece safety boundaries, structured evidence requirements, human-review semantics, and no-tag-unless-explicit policy.
---

# Setpiece Release Validation

## Release Gate Workflow

Use this workflow for Setpiece release validation, packaged desktop dogfood,
